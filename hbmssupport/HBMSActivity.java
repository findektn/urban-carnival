...
import com.hbms.usermanagment.MainActivity_mgmt;
...
import com.hbms.hbmssupport.SoapObjectConstans;
...
//        String vibPref= pref.getString("vibration", null);
    ...
    public void onStop() {
        tts.stop();
        Log.println(Log.INFO, "Finde", "--->close!!!!");
        timerParam.cancel();
        timerSupport.cancel();
        super.onStop();
        finish();
    ...
    class CAllGetSupportObj extends AsyncTask<String, String, SoapObject>{
        ...
        protected SoapObject doInBackground(String... params) {
            WebserviceCallSupport cs = new WebserviceCallSupport();
            return cs.Call(HOST);
        }
        ...
        protected void onPostExecute(SoapObject result) {
            try {
                if (result != null) {
                    ...
                    SoapObjectConstans.soapObj=result;
